...
async function main() {
  console.log('===========================================================');
  console.log('Memulai Historical News Scraper (APPEND MODE 3)');
  console.log('Target: New specific keywords requested by user (batch 3)');
  console.log('===========================================================');
  ...
  const targetKeywords = [
    '"ijin usaha" OR "kaki lima" OR "asongan" OR "rumahan"',
    '"proyek pembangunan" OR "menyerap tenaga kerja" OR "mengentaskan pengangguran"'
  ];
