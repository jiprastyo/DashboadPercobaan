...
import { NEWS_SOURCES, KBLI_SECTORS, SECTOR_KEYWORDS } from '../../src/lib/constants';
...
async function main() {
  console.log('===========================================================');
  console.log('Memulai Historical News Scraper (APPEND MODE)');
  console.log('Target: New specific keywords requested by user');
  console.log('===========================================================');
  ...
  const targetKeywords = [
    '"pekerja formal" OR "pekerja informal" OR "usaha formal" OR "usaha informal"',
    '"blue collar" OR "white collar" OR "wirausaha" OR "membuka lapangan kerja"',
    '"padat karya" OR "PRT" OR "pembantu rumah tangga" OR "TKI"',
    '"tenaga kerja indonesia" OR "tenaga kerja asing" OR "pekerja anak"',
    '"decent work" OR "pekerjaan berbahaya" OR "setengah penganggur" OR "penganggur"'
  ];
