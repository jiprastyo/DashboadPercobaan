...
export function getSampleNewsData(): NewsArticle[] {
  return [
    ...
    { id: "n4", title: "Investasi Asing Masuk Rp 142 Triliun di Q1 2026, Serap 1,2 Juta Tenaga Kerja", date: "2026-06-02", source: "katadata", source_name: "Katadata", excerpt: "Realisasi investasi asing (PMA) kuartal I 2026 mencapai Rp 142 triliun, menyerap 1,2 juta tenaga kerja baru terutama di sektor manufaktur dan infrastruktur.", sector_tags: ["industri", "konstruksi"], keywords_matched: ["tenaga kerja", "investasi"], _source_url: "https://katadata.co.id/investasi-q1-2026", _scraped_at: "2026-06-02T06:00:00Z" },
    { id: "n5", title: "Startup Teknologi Lakukan Efisiensi, 850 Karyawan Dirumahkan", date: "2026-06-01", source: "cnn", source_name: "CNN Indonesia", excerpt: "Tiga startup teknologi besar di Indonesia melakukan restrukturisasi dengan merumahkan total 850 karyawan. Langkah ini diambil untuk mencapai profitabilitas.", sector_tags: ["infokom"], keywords_matched: ["PHK", "karyawan"], _source_url: "https://www.cnnindonesia.com/startup-efisiensi-2026", _scraped_at: "2026-06-01T06:00:00Z" },
    { id: "n6", title: "Ekspor Nikel Olahan Meningkat, Industri Smelter Rekrut 15 Ribu Pekerja Baru", date: "2026-05-30", source: "bloomberg", source_name: "Bloomberg Technoz", excerpt: "Industri smelter nikel di Sulawesi dan Maluku merekrut 15.000 pekerja baru seiring meningkatnya permintaan nikel olahan untuk baterai kendaraan listrik.", sector_tags: ["pertambangan", "industri"], keywords_matched: ["tenaga kerja", "rekrut"], _source_url: "https://www.bloombergtechnoz.com/nikel-smelter-2026", _scraped_at: "2026-05-30T06:00:00Z" },
  ];
}
