...
- **Chart Export Controls**: PNG export remains available in Makro ASEAN, while the Makro Indonesia TPT PNG controls are temporarily removed until the browser-side export behavior is reliable again.
