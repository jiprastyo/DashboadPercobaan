...
- **Reusable PNG Export for Charts**: `Salin PNG` / `Unduh PNG` in Makro Indonesia and Makro ASEAN now use a shared SVG-to-PNG export helper that targets the actual rendered Recharts surface instead of incidental icon SVGs.
